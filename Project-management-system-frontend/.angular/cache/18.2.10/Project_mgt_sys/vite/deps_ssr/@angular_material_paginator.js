...
import {
  ...
  transition,
  trigger
} from "./chunk-YRCD3QB7.js";
import {
  CommonModule,
  DOCUMENT,
  Location,
  NgClass
} from "./chunk-NP2MXEPL.js";
import {
...
var MatTooltip = class _MatTooltip {
  ...
  constructor(_overlay, _elementRef, _scrollDispatcher, _viewContainerRef, _ngZone, _platform, _ariaDescriber, _focusMonitor, scrollStrategy, _dir, _defaultOptions, _document) {
    ...
    _dir.change.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe(() => {
      if (this._overlayRef) {
        this._updatePosition(this._overlayRef);
      }
    });
...
var TooltipComponent = class _TooltipComponent {
  constructor(_changeDetectorRef, _elementRef, animationMode) {
    ...
    this._onHide = new import_rxjs3.Subject();
...
var MatPaginatorIntl = class _MatPaginatorIntl {
  constructor() {
    this.changes = new import_rxjs4.Subject();
...
var MatPaginator = class _MatPaginator {
  ...
  constructor(_intl, _changeDetectorRef, defaults2) {
    ...
    this._isInitialized = false;
    this._initializedStream = new import_rxjs4.ReplaySubject(1);
    this._pageIndex = 0;
    this._length = 0;
